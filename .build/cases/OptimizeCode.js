...
OptimizeCode.ask = `Com base nas instruções passadas, otimize esse bloco de código e retorne em markdown apenas o novo código gerado entre (\`\`\`), sem explicações:`;
