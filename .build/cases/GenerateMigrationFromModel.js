...
\`\`\``;
GenerateMigrationFromModel.ask = `Com base no modelo acima, gere uma sequelize ORM migration à partir deste model. Você deve responder em markdown apenas o novo código e entre (\`\`\`). Sem explicações. Apenas o novo código::`;
